...
<div class="max-w-7xl mx-auto">
    <div class="bg-white border border-slate-200 rounded-2xl p-5 mb-4 shadow-sm">
        <div class="flex items-center gap-3">
            ...
            <div>
                <div class="text-xs font-bold uppercase tracking-widest text-violet-500">IT · Discharge summaries</div>
            ...
            <tbody class="divide-y divide-slate-100">
                    ...
                    <tr class="hover:bg-slate-50">
                        ...
                        <td class="px-4 py-3 text-right">
                            @include('hhrr._shared._action_buttons', [
                                'showRoute'   => route('clinical.it.discharges.show', $d),
                                'editRoute'   => $d->is_signed ? null : (auth()->user()->can('clinical.it.discharges.edit') ? route('clinical.it.discharges.edit', $d) : null),
                                'deleteRoute' => $d->is_signed ? null : (auth()->user()->can('clinical.it.discharges.delete') ? route('clinical.it.discharges.destroy', $d) : null),
                ...
                @empty
                    <tr><td colspan="8" class="px-5 py-16 text-center text-slate-400 text-sm">
                        ...
                        No discharges yet — start one from a patient's IT admission.
                    </td></tr>
                @endforelse
            </tbody>
        </table>
