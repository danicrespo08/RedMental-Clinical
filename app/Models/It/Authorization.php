...
class Authorization extends Model
{
    ...
    protected $table = 'it_authorizations';
    ...
    protected $fillable = [
        'client_id', 'it_admission_id', 'patient_id', 'payer_id',
    ...
    public function serviceLogs(): HasMany { return $this->hasMany(ServiceLog::class, 'it_authorization_id'); }
