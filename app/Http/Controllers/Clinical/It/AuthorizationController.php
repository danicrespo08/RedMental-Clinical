...
class AuthorizationController extends Controller
{
    public function index(Request $request): View
    {
        ...
        $auths = Authorization::query()
            ...
            ->paginate(20)
            ->withQueryString();
        return view('clinical.it.authorizations.index', [
            'auths'    => $auths,
    ...
    public function create(Request $request): View
    {
        ...
        return view('clinical.it.authorizations.form', [
    ...
    public function store(Request $request): RedirectResponse
    {
        ...
        return redirect()->route('clinical.it.authorizations.show', $auth)
    ...
    public function show(Authorization $authorization): View
    {
        ...
        return view('clinical.it.authorizations.show', ['auth' => $authorization]);
    }
    ...
    public function update(Request $request, Authorization $authorization): RedirectResponse
    {
        ...
        return redirect()->route('clinical.it.authorizations.show', $authorization)
    ...
    public function destroy(Authorization $authorization): RedirectResponse
    {
        ...
        return redirect()->route('clinical.it.authorizations.index')
