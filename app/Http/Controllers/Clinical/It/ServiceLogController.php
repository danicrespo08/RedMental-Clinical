...
class ServiceLogController extends Controller
{
    ...
    {
        $previousAuthId = $serviceLog->it_authorization_id;
        $serviceLog->update($this->validated($request));
        foreach (array_unique(array_filter([$previousAuthId, $serviceLog->it_authorization_id])) as $authId) {
    ...
    {
        $authId = $serviceLog->it_authorization_id;
        $serviceLog->delete();
        Authorization::find($authId)?->recalcUnitsUsed();
